...
class LookupModule(LookupBase):
    ...
    def run(self, terms, variables=None, **kwargs):
        ...
        if HAVE_DNS == False:
            raise LookupError("Can't LOOKUP(dig): module dns.resolver is not installed")
                ...
                for ns in nsset:
                    ...
                    try:
                        ...
                        try:
                            ...
                            raise LookupError("dns lookup NS: ", str(e))
        ...
        if qtype.upper() == 'PTR':
            try:
                ...
                raise LookupError("dns.reversename unhandled exception", str(e))
